...
function _displayTweets() {
  _displayTweets = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(_criadorDoPost) {
    var tweetsContainer, tempPosts, posts, i, tweetElement, userIcon, tweetInner, likeButton;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.next = 5;
          return contract.methods.visualizarTodosOsPosts(_criadorDoPost).call();
        case 5:
          tempPosts = _context5.sent;
          // we do this so we can sort the tweets  by timestamp
          posts = _toConsumableArray(tempPosts);
          ...
          for (i = 0; i < posts.length; i++) {
            ...
            userIcon.src = "https://avatars.dicebear.com/api/human/".concat(posts[i].autor, ".svg");
            userIcon.alt = "User Icon";
            tweetElement.appendChild(userIcon);
            tweetInner = document.createElement("div");
            tweetInner.className = "tweet-inner";
            tweetInner.innerHTML += "\n        <div class=\"author\">".concat(shortAddress(posts[i].autor), "</div>\n        <div class=\"content\">").concat(posts[i].conteudo, "</div>\n    ");
            likeButton = document.createElement("button");
            likeButton.className = "like-button";
            likeButton.innerHTML = "\n        <i class=\"far fa-heart\"></i>\n        <span class=\"likes-count\">".concat(posts[i].curtidas, "</span>\n    ");
            likeButton.setAttribute("data-id", posts[i].id);
            likeButton.setAttribute("data-author", posts[i].autor);
            addLikeButtonListener(likeButton, userAddress, posts[i].id, posts[i].autor);
